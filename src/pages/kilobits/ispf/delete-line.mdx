...
description: |
    New to the ISPF Editor? Learn to quickly delete lines to mainframe code using the Delete Line command using this beginner-friendly guide.
...
1. Place your cursor at the start of line number area where you want to insert a line (e.g, `000800`).
...
1. Place your cursor at the start of line number area where you want to delete lines (e.g, `000200`).
...
1. Enter `DD` in the line number area of the first line you want to delete (e.g., 000200).
2. Enter `DD` in the line number area of the last line you want to delete (e.g., 000400).
