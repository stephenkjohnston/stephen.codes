...
2. A **VARIABLE NAME**, refers to the name we'll use to access this item later on in the program. Like in every programming language it has some rules; one of which flys against everything I was thought about variables 😀. Getting back on track now, these rules are:
